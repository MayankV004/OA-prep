    ...
    <div ref={containerRef} className="min-h-screen bg-background text-foreground font-sans overflow-hidden selection:bg-primary/30">
      ...
      >
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-pink-500 to-pink-300 shadow-[0_0_20px_rgba(236,72,153,0.4)]">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/sign-up">
            <button className="h-10 px-6 rounded-full font-bold text-white bg-gradient-to-r from-pink-600 via-pink-500 to-pink-400 hover:shadow-[0_0_25px_rgba(236,72,153,0.6)] transition-all hover:scale-105 active:scale-95 border-none">
              Get Started
            </button>
          </Link>
        </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 px-4">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <motion.div style={{ y: y2 }} className="absolute top-[30%] right-[15%] text-3xl font-black text-pink-300/20 blur-[1px]">Docker</motion.div>
          <motion.div style={{ y: y3 }} className="absolute bottom-[40%] left-[20%] text-4xl font-bold text-pink-500/20 blur-[3px]">Kubernetes</motion.div>
          <motion.div style={{ y: y4 }} className="absolute top-[50%] right-[25%] text-xl font-medium text-pink-400/20 blur-[1px]">DBMS</motion.div>
          ...
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-pink-400/20 rounded-full blur-[120px]" />
        </div>
        ...
        >
          <motion.h1 variants={fadeIn} className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter text-foreground leading-[1.1]">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 dark:from-pink-300 dark:via-pink-400 dark:to-pink-500">
              Zero Distractions.
            </span>
          </motion.h1>
          ...
          <motion.div variants={fadeIn} className="flex flex-col sm:flex-row items-center justify-center gap-5 pt-4">
            <Link href="/sign-up">
              <button className="flex items-center h-14 px-8 rounded-full text-lg font-bold text-white bg-gradient-to-r from-pink-600 via-pink-500 to-pink-400 hover:shadow-[0_0_40px_rgba(244,114,182,0.5)] transition-all hover:scale-105 active:scale-95 border-none">
      ...
      <section id="editor" className="py-32 px-4 relative">
        ...
        >
          ...
          <div className="rounded-3xl bg-foreground/[0.03] backdrop-blur-2xl shadow-[0_20px_60px_-15px_rgba(244,114,182,0.15)] overflow-hidden flex flex-col md:flex-row min-h-[500px]">
            {/* Editor Side */}
            <div className="flex-1 p-6 md:p-8 bg-foreground/5 dark:bg-black/40">
              ...
              <div className="font-mono text-sm md:text-base text-pink-700 dark:text-pink-200/80 space-y-2">
                <p><span className="text-pink-500 dark:text-pink-400">##</span> Sliding Window Pattern</p>
                <p className="text-foreground/80">Used to find a subarray or substring that satisfies a specific condition.</p>
                <br/>
                <p><span className="text-pink-500 dark:text-pink-400">```python</span></p>
                <p className="text-pink-600 dark:text-pink-300">def <span className="text-pink-500 dark:text-pink-200">max_sum</span>(arr, k):</p>
                <p className="pl-4 text-foreground/80">window_sum = sum(arr[:k])</p>
                <p className="pl-4 text-foreground/80">max_val = window_sum</p>
                <p><span className="text-pink-500 dark:text-pink-400">```</span></p>
              </div>
            </div>
            {/* Preview Side */}
            <div className="flex-1 p-6 md:p-8 bg-foreground/[0.02]">
              <div className="flex items-center mb-6">
                <span className="text-xs font-semibold text-pink-600 dark:text-pink-400/80 uppercase tracking-widest">Live Preview</span>
              </div>
              <div className="prose dark:prose-invert prose-slate max-w-none">
                ...
                <div className="bg-foreground/5 dark:bg-black/50 rounded-xl p-4 font-mono text-sm border border-foreground/5 shadow-inner">
                  <span className="text-pink-500 dark:text-pink-400">def</span> <span className="text-pink-600 dark:text-pink-300">max_sum</span>(arr, k):<br/>
      ...
      <section id="progress" className="py-32 px-4 relative overflow-hidden" ref={progressRef}>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-pink-900/10 rounded-full blur-[100px] pointer-events-none" />
