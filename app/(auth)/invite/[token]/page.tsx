...
export default function InvitePage({ params }: { params: Promise<{ token: string }> }) {
  ...
  if (fetchError) {
    return (
      <div className="animate-in-up text-center">
        ...
        <Button
          size="xl"
          className="mt-7 w-full bg-primary text-primary-foreground hover:bg-primary/90 font-bold shadow-xs border-none cursor-pointer"
  ...
  return (
    <div className="animate-in-up">
      <span
        aria-hidden
        className="mb-5 grid size-11 place-items-center rounded-xl bg-primary/10 text-primary border border-primary/20"
      >
